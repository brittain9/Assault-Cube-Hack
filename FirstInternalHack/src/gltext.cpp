...
void GL::Font::Build(int height)
{
	hdc = wglGetCurrentDC();
	base = glGenLists(96);
	HFONT hFont = CreateFontA(-height, 0, 0, 0, FW_MEDIUM, FALSE, FALSE, FALSE, ANSI_CHARSET, OUT_TT_ONLY_PRECIS, GL_CLIP_PLANE1, PROOF_QUALITY, FF_DONTCARE | DEFAULT_PITCH, "Consolas");
